  ...
  return (
    <div className="flex items-center justify-center  min-h-52 ">
      <div className="relative flex items-center flex-col  sm:flex-row">
        <div className="bg-[#000] z-2 sm:z-0 border border-white/30 mb-7 sm:mb-0 rounded-2xl flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 p-4 ">
          <Image src={logos[0]} alt="Logo 1" width={40} height={40} className="filter invert brightness-0" />
        </div>

        <div className="relative rotate-90 sm:rotate-0" style={{ width: `${lineWidth}px`, height: `${lineHeight}px`, backgroundColor: '#FFFFFF', overflow: 'hidden' }}>
          <motion.div
        ...
        <div className="relative z-2 sm:z-0  bg-black border-2 border-white/70 rounded-2xl flex items-center justify-center  w-14 h-14 sm:w-16 sm:h-16 p-4 overflow-hidden shadow-[0_0_15px_5px_#dbe0e2]">
          <Image src={logos[1]} alt="Logo 2" width={40} height={40} className="filter invert brightness-0" />
          <motion.div
        ...
        <div className="bg-black border z-3 sm:z-0 mt-7 sm:mt-0 border-white/30 rounded-2xl flex items-center justify-center  w-12 h-12 sm:w-14 sm:h-14 p-4">
          <Image src={logos[2]} alt="Logo 3" width={40} height={40} className="filter invert brightness-0" />
        </div>
      </div>
    </div>
  );
...
const CardWithEffect=({children}:{children:React.ReactNode})=>{
    const [mousePostion,setMousePostion]=useState({x:0,y:0});
      ...
      const handleMouseMove=(e:React.MouseEvent<HTMLDivElement>)=>{
        ...
        setMousePostion({x:e.clientX- rect.left, y: e.clientY - rect.top});
      };
      ...
      {isHovered && (
        <div
          ...
          style={{
            width: '300px',
            height: '300px',
            top: mousePostion.y - 150,
            left: mousePostion.x - 150,
            background: '#5D2CA8',
            filter: 'blur(100px)',
  ...
  return (
    <div className="flex flex-col justify-center h-full items-center relative ">
         ...
         <div className="relative bg-black border-2 border-white/70 rounded-2xl flex items-center justify-center w-16 h-16 p-4 overflow-hidden shadow-[0_0_15px_5px_#dbe0e2]">
          <Image src={logos[0]} alt="Logo 2" width={40} height={40} className="filter invert brightness-0" />
          <motion.div
            className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white to-transparent opacity-30"
            initial={{ x: '-100%' }}
            animate={{ x: '100%' }}
        ...
        <div className="relative bg-black border-2 border-white/70 rounded-2xl flex items-center justify-center w-16 h-16 p-4 overflow-hidden shadow-[0_0_15px_5px_#dbe0e2]">
          <Image src={logos[2]} alt="Logo 2" width={40} height={40} className="filter invert brightness-0" />
          <motion.div
            className="absolute top-0 left-0 w-full h-full bg-gradient-to-r from-transparent via-white to-transparent opacity-30"
            initial={{ x: '-100%' }}
            animate={{ x: '100%' }}
...
const BentoBox1 = () => {
 ...
 return (
    <div className="bg-[#000000] flex justify-center items-center p-5  rounded-lg sm:py-10 ">
      <div className="flex flex-col  md:flex-row gap-4    w-full sm:w-full max-w-5xl min-h-[800px] md:min-h-[800px] md:h-[800px]">
        <CardWithEffect>
